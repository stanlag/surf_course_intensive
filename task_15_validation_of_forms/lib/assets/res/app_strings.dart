abstract class AppStrings {
  ...
  static const parrot = 'Попугай';
  static const petName = 'Имя питомца';
  static const petNameValidation = 'Укажите имя питомца от 3 до 20 символов';
  static const birthDate = 'День рождения питомца';
  static const birthDateValidation = 'Поле должно соответствовать шаблону вида ДД.ММ.ГГГГ';
  static const weight = 'Вес, кг';
  static const weightValidationEmpty = 'Поле не должно быть пустым';
  static const weightValidationInvalid = 'Значение должно быть числом больше 0';
  static const ownerEmail = 'Электронная почта хозяина';
